...
Route::group(['middleware' => ['auth', 'usersession']], function () {
    ...
    Route::any('admin/branch', [AdminBranchesController::class, 'index']);
    Route::get('admin/fetchall', [AdminBranchesController::class, 'fetchAll'])->name('fetchAll');
    Route::post('admin/add-branch', [AdminBranchesController::class, 'store']);
    Route::get('admin/branch/destroy/{id}', [AdminBranchesController::class, 'destroy']);
    Route::get('admin/edit-branch', [AdminBranchesController::class, 'edit']);
    Route::post('admin/update-branch', [AdminBranchesController::class, 'update']);
});
